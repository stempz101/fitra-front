...
import EmailEditModal from "./user/EmailEditModal";
import PasswordEditModal from "./user/PasswordEditModal";
                        ...
                        <Modal.Body>
                            <Form onSubmit={handleFormSubmit}>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control as="textarea" name="about" placeholder="Write here..."
